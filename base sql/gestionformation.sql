...
--
-- Hôte : localhost
-- Généré le :  mer. 14 mars 2018 à 12:17
...
--
-- Déchargement des données de la table `tb_equipe`
--
...
--
-- Déchargement des données de la table `tb_formation`
--

INSERT INTO `tb_formation` (`frm_id`, `frm_contenu`, `frm_date`, `frm_nbjours`, `frm_prerequis`, `frm_cout`) VALUES
(1, 'Développement de programme en C', '2018-07-02', 5, 'Connaissances en programmation informatique', '1200'),
(11, 'Respecter le GEMRCN dans les entreprises', '2018-07-25', 3, 'Travailler dans l\'équipe restauration', '1200'),
(6, 'Le prospect de clients3', '2018-09-07', 5, 'Connaissances en marketing', '500'),
(7, 'Initiation au développement web', '2018-10-15', 4, 'Connaissances de bases en informatique', '600'),
(9, 'Embauche d\'alternant et avantages fiscaux', '2018-06-15', 2, 'Connaissance de la fiscalité des entreprises', '800'),
(10, 'Les bonnes pratiques du marketing digital', '2018-10-16', 1, 'Professionnel du marketing', '400');
...
--
-- Déchargement des données de la table `tb_formationhistorique`
--
...
--
-- Déchargement des données de la table `tb_inscrire`
--
